...
from src.pipeline.rag_pipeline import run_full_rag_debug_pipeline
from src.utils.config import load_json_config


def parse_args():
    parser = argparse.ArgumentParser(
        description="Run the RAG debate pipeline from a config file."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the RAG pipeline config JSON file.",
    )
